    ...
    <footer className="bg-[#000] text-center py-10 text-white flex items-center justify-center flex-col">
      <div className='flex flex-row mb-10 gap-4'>
        ...
        <Link href={"http://www.yelp.com/biz/mgm-roast-beef-washington"} target='_blank' rel='noopener noreferrer'>
          <div className={`rounded-lg flex justify-center items-center w-12 h-12 bg-[#FF1A1A]`} title='Yelp'>
            <FaYelp className="text-3xl cursor-pointer" />
          </div>
        </Link>

        <Link href={"tel:202-248-0389"} target='_blank' rel='noopener noreferrer'>
          <div className={`rounded-lg flex justify-center items-center w-12 h-12 bg-[#25D366]`} title='Phone'>
        ...
        <Link href={"https://instagram.com/mgmroastbeef/"} target='_blank' rel='noopener noreferrer'>
          <div className={`rounded-lg flex justify-center items-center w-12 h-12 bg-[#e1306c]`} title='Instagram'>
      ...
      <p className="text-xl font-semibold font-italiana mt-4">{`© ${new Date().getFullYear()} Centro Italian Catering. All rights reserved.`}</p>
    </footer>
  )
}
